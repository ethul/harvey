...
import com.harvey.domain.util._
import com.harvey.service.sound.{MidiSink,MidiProgramSignal,SoundDevice,SoundException}
import com.harvey.service.sound.{MidiSource,SignalSource,MidiSignalOnWithDuration,SignalPattern}
import com.harvey.service.sound.{SignalContext,MidiSignalContext}
import com.harvey.service.sound.{SignalCompositeOperation,SignalFlattenAmplitude,SignalEvenlyDistributeDuration,SignalBinaryFission,SignalBinaryFusion,SignalMetaGeneratePattern}
import com.harvey.service.sound.{SignalIdentity,SignalReverse,SignalInverse,SignalFlipFlop,SignalHalfs,SignalAccentOneThree,SignalModulate,SignalDoubleDuration,SignalHalfDuration}
